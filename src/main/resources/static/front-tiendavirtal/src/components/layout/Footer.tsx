/**
 * @fileoverview Componente Footer de la aplicación
 * @description Footer con información de contacto, links importantes y redes sociales
...
/**
 * Secciones del footer organizadas por categorías
 */
...
interface FooterProps {
  /** Información de contacto personalizada (opcional) */
  contactInfo?: Partial<ContactInfo>;
  /** Secciones personalizadas del footer (opcional) */
 ...
 * 
 * @param contactInfo - Información de contacto personalizada
 * @param sections - Secciones del footer
 * @param showSocial - Mostrar redes sociales
 * @param showContact - Mostrar información de contacto
 */
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">{finalContactInfo.phone}</span>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-700">{finalContactInfo.address}</span>
                </div>
